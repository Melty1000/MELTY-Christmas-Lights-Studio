...
export function createBulbInstance(colorHex, themePalette, activeWireColorA) {
    ...
    // Filament (EMISSIVE - light source)
    ...
    const glassMat = new THREE.MeshPhysicalMaterial({
        ...
        side: THREE.FrontSide, // Fix for half-dark glitch (was DoubleSide)
        transparent: true,
    ...
    const sMat = new THREE.MeshStandardMaterial({ color: activeWireColorA, roughness: 0.5, metalness: 0.2, side: THREE.DoubleSide });
